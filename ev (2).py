...
# --- ฟังก์ชันอ่านข้อมูลจาก Google Sheets (เพิ่มระบบทำความสะอาดชื่อคอลัมน์ป้องกันเว้นวรรค) ---
def load_sheet_data(worksheet_name):
    try:
        ...
        # ทำความสะอาดชื่อคอลัมน์: ลบช่องว่างหัว-ท้าย และแปลงเป็นตัวพิมพ์เล็กทั้งหมดโดยอัตโนมัติ
...
def login_user(username, password):
    ...
    # ดึงแถวข้อมูลของผู้ใช้ (แปลงข้อมูลเป็นตัวพิมพ์เล็กและตัดช่องว่างเพื่อความแม่นยำ)
    user_row = df_users[df_users["username"].astype(str).str.strip() == str(username).strip()]
    if user_row.empty:
